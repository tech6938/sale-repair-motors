...
class PreprationManagerController extends Controller
{
    /**
    ...
    {
        return view('prepration-manager.index');
    }
    ...
    public function store(StaffStoreRequest $request)
    {
        try {
            ...
            $staff->assignRole(User::ROLE_PREPARATION_MANAGER);
    ...
    {
        $dt = DataTables::of(User::applyRoleFilter()->preprationManager()->with('manager')->latest());
