...
class ManagerStaffController extends Controller
{
    ...
    {
        return view('manager-staffs.index');
    }
    ...
    {
        return view('manager-staffs.modals.create');
    }
    ...
    public function store(StaffStoreRequest $request)
    {
        try {
            ...
            $staff->assignRole(User::ROLE_ADMIN_STAFF);

            DB::commit();

            return $this->jsonResponse(['message' => 'Manager Staff has been created successfully.']);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        return view('manager-staffs.modals.show', compact('staff'));
    }
    ...
    {
        return view('manager-staffs.modals.edit', compact('staff'));
    }
